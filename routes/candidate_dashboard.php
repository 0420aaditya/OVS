...
<html>
<head>
    <title>Online voting system - Candidate Dashboard</title>
...
<div class="container">
    <div id="headerSection" class="d-flex justify-content-between align-items-center">
        <div>
            <a href="../routes/candidate_login.php" class="btn btn-primary" id="back-button">Back</a>
        </div>
        <div>
            <h1 class="text-center">Online Voting System</h1>
            <h3 class="text-center">Candidate Dashboard</h3>
        </div>
        <div>
